...
***Note:*** Dutch National Flag Algorithm used on sorting a list of **three** different types of values. In this case, we consider **0, 1, and 2** as three different values.